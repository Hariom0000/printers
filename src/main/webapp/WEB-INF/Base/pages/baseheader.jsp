...
<%-- style="background-image: url('${img_url}/login.jpg');height: 100px;vertical-align: middle;" --%>
<div class="row" style="background-image: url('${img_url}/login.jpg');height: 100px;vertical-align: middle;">
	<div class="col-md-9"></div>
	<div class="col-md-3">
		<img width="60px" height="35px" style="z-index: -11;" src="${img_url}/default_avatar_male.jpg">
