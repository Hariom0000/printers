...
<script src="${js_url}/card/cardsize.js"></script>
<div class="tabbable">
		...
		<div class="tab-pane" id="tab2">
			<div class="row">
				<form id="validate" method="POST" 
					action="javascript:createCradSize();">
					<div class="col-md-12">
						<div class="col-md-6">
							<fieldset class="form-group">
								<div class="col-md-4" style="padding-top: 5px;">
									<label for="formGroupExampleInput">Card Size</label> <input
										type="text" id="id" name="id" style="display: none;">
								</div>
								<div class="col-md-8">
									<input type="text" class="form-control validate[required]"
										name="size" id="size" placeholder="enter card type" />
								</div>
							</fieldset>
							<fieldset class="form-group">
								<div class="col-md-4" style="padding-top: 5px;">
