				...
				<div class="col-md-12">
					<form id="validate" method="POST"
						...
						<div class="col-md-6">
							...
							<fieldset class="form-group">
								<div class="col-md-4" style="padding-top: 5px;">
									<label for="formGroupExampleInput">IMG on Card</label>
								</div>
								<div class="col-md-8">
							...
							<fieldset class="form-group">
								<div class="col-md-4" style="padding-top: 5px;">
									<label for="formGroupExampleInput">Card Size</label>
								</div>
								<div class="col-md-8">
									<select id="cardSizeId"
										name="cardSizeId"
										class="form-control validate[required]">
									</select>
								</div>
									...
									<div class="file-input">
										<div class="file-preview ">
											<div class="file-drop-disabled">
												<div class="file-preview-thumbnails">
													<div class="file-default-preview">
														<img alt="Your Avatar" id="modelmainImg" src="/HimanshiPrinters/img/default_avatar_male.jpg"
									...
									<div class="file-input">
										<div class="file-preview ">
											<div class="file-drop-disabled">
												<div class="file-preview-thumbnails">
													<div class="file-default-preview">
														<img alt="Your Avatar" id="modelfrontImg" src="/HimanshiPrinters/img/default_avatar_male.jpg"
															style="width: 160px;height: 120px;">
													</div>
												</div>
												<div class="clearfix"></div>
									...
									<div class="file-input">
										<div class="file-preview ">
											<div class="file-drop-disabled">
												<div class="file-preview-thumbnails">
													<div class="file-default-preview">
														<img alt="Your Avatar" id="modelmiddleImg" src="/HimanshiPrinters/img/default_avatar_male.jpg"
															style="width: 160px;height: 120px;">
													</div>
												</div>
												<div class="clearfix"></div>
									...
									<div class="file-input">
										<div class="file-preview ">
											<div class="file-drop-disabled">
												<div class="file-preview-thumbnails">
													<div class="file-default-preview">
														<img alt="Your Avatar" id="modellastImg" src="/HimanshiPrinters/img/default_avatar_male.jpg"
															style="width: 160px;height: 120px;">
													</div>
												</div>
												<div class="clearfix"></div>
