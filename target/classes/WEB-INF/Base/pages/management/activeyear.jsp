...
<script src="${js_url}/card/activeyear.js"></script>
<div class="tabbable">
		...
		<div class="tab-pane" id="tab2">
			<div class="row">
				<form id="validate" method="POST" 
					action="javascript:createactiveyear();">
					<div class="col-md-12">
						<div class="col-md-6">
							<fieldset class="form-group">
								<div class="col-md-4" style="padding-top: 5px;">
									<label for="formGroupExampleInput">ActiveYear</label> <input
										type="hidden" id="id" name="id">
								</div>
								<div class="col-md-8">
									<input type="text" class="form-control validate[required]"
										name="year" id="year" placeholder="enter active year" />
								</div>
							</fieldset>
							<fieldset class="form-group">
								<div class="col-md-4" style="padding-top: 5px;">
